...
// All BCpu instructions have 4-byte size
static constexpr size_t BCpuInstrSize = 4;

class BCpuInstrInfo : public BCpuGenInstrInfo {
  const MCInstrDesc &getBrCond(BCpuCC::CondCode CC) const;
